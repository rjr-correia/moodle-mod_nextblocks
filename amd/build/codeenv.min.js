...
define ("mod_nextblocks/codeenv", ['mod_nextblocks/lib', 'mod_nextblocks/repository', 'mod_nextblocks/chat'], function (lib, repository, chat) {
...
javascript.javascriptGenerator.forBlock.text_ask = function (block, generator) {
  ...
  return "  customPrint(" + question + ");\n" + "  var answer = await input(" + question + ");\n" + "  customPrintln(answer);\n";
};
Blockly.Blocks['text_ask'] = {
  init: function () {
    this.appendValueInput("TEXT").setCheck(null).appendField("ask");
