...
define ("mod_nextblocks/codestring", [], function () {
  class CodeString {
    #codeString;
    #originalCodeString;
...
`;
    ...
    getPrintableCodeString() {
      const codeLines = this.#codeString.replaceAll("customPrintln", "print").replaceAll("text_to_number", "parseFloat").split(/(?<!\\)\n/);
