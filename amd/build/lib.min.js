 ...
 */define ("mod_nextblocks/lib", ['mod_nextblocks/codestring'], function (CodeString) {
  ...
  return {
    ...
    testsAccordion: function (results, testsJSON) {
      ...
      for (let i = 0; i < testCaseCount; i++) {
        ...
        } else if (results[i].includes("Error") && results[i].includes("Maximum execution time exceeded")) {
          accordion += '<pre class="mt-1 mb-0 test-output" style="color: red !important;">' + 'Error: Maximum execution time exceeded</pre>';
        } else {
