...
Blockly.Msg["TEXT_PRINT_TOOLTIP"] = "Print the specified text, number or other value.";  // untranslated
  Blockly.Msg["TEXT_ASK_HELPURL"] = "https://github.com/google/blockly/wiki/Text#printing-text";  // untranslated
  Blockly.Msg["TEXT_ASK_TITLE"] = "print %1";  // untranslated
  Blockly.Msg["TEXT_ASK_TOOLTIP"] = "Print the specified text, number or other value.";  // untranslated
